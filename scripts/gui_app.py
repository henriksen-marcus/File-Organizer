...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.folderSelect = customtkinter.CTkEntry(self.folderEntryContainer, width=200)
        ...
        # Search tab
        self.fileTypeTab = customtkinter.CTkTabview(self.titleFrame, height=145, command=self.update_folder_info_manual)
